    ...
    <main>
        <div class="container">
            ...
            <div class="product-list">
                ...
                <div class="product">
                    <img src="/PWL_2024/resources/img/susu.jpg" alt="Minuman Segar">
                    <h3>Minuman Segar</h3>
                    <p>Berbagai pilihan minuman segar untuk melegakan dahaga Anda.</p>
                    <a href="#">Detail</a>
                </div>

                <div class="product">
                    <img src="/PWL_2024/resources/img/snack.jpg" alt="Makanan Ringan">
                    <h3>Makanan Ringan</h3>
                    <p>Camilan lezat untuk menemani aktivitas Anda.</p>
                    <a href="#">Detail</a>
                </div>

                <div class="product">
                    <img src="/PWL_2024/resources/img/nasgor.jpg" alt="Makanan Berat">
                    <h3>Makanan Berat</h3>
                    <p>Hidangan mengenyangkan untuk mengisi perut Anda.</p>
                    <a href="#">Detail</a>
                </div>

                <div class="product">
                    <img src="/PWL_2024/resources/img/kopi.jpg" alt="Kopi">
                    <h3>Kopi</h3>
                    <p>Kopi pilihan dengan aroma dan rasa yang nikmat.</p>
                    <a href="#">Detail</a>
                </div>
