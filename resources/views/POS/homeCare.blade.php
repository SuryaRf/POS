    ...
    <main>
        <div class="container">
            ...
            <div class="product-list">
                ...
                <div class="product">
                    <img src="/PWL_2024/resources/img/detergen.jpg" alt="Minuman Segar">
                    <h3>Detergen</h3>
                    <p>Wangi dan bersih</p>
                    <a href="#">Detail</a>
                </div>

                <div class="product">
                    <img src="/PWL_2024/resources/img/penggosok.jpg" alt="Makanan Ringan">
                    <h3>Brush</h3>
                    <p>Bersihkan daki anda</p>
                    <a href="#">Detail</a>
                </div>

                <div class="product">
                    <img src="/PWL_2024/resources/img/scrub.jpg" alt="Makanan Berat">
                    <h3>Spons</h3>
                    <p>Spons cuci piring</p>
                    <a href="#">Detail</a>
                </div>

                <div class="product">
                    <img src="/PWL_2024/resources/img/pewangi.jpg" alt="Kopi">
                    <h3>Pewangi baju</h3>
                    <p>Pastikan bajumu wangi</p>
                    <a href="#">Detail</a>
                </div>
