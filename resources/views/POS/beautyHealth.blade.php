...
<body>
    ...
    <main>
        <div class="container">
            <h2>Kecantikan & Kesehatan</h2>
            <div class="product-list">

                <div class="product">
                    <img src="/PWL_2024/resources/img/skintific.jpg" alt="Minuman Segar">
                    <h3>Skintific</h3>
                ...
                <div class="product">
                    <img src="/PWL_2024/resources/img/serum.jpg" alt="Makanan Ringan">
                    <h3>Serum</h3>
                    <p>Mengurangi kerutan</p>
                    <a href="#">Detail</a>
                </div>

                <div class="product">
                    <img src="/PWL_2024/resources/img/sunscreen.jpg" alt="Makanan Berat">
                    <h3>Sunscreen</h3>
                    <p>Melindungi dari paparan matahari</p>
                    <a href="#">Detail</a>
                </div>

                <div class="product">
                    <img src="/PWL_2024/resources/img/strep.jpg" alt="Kopi">
                    <h3>Strepsils</h3>
                    <p>Melegakan Tenggorokan</p>
                    <a href="#">Detail</a>
                </div>

                <div class="product">
                    <img src="/PWL_2024/resources/img/pepsodent.jpg" alt="Makanan Berat">
                    <h3>Pepsodent</h3>
                    <p>Merawat gigi dengan pasta gigi terbaik</p>
                    <a href="#">Detail</a>
                </div>

                <div class="product">
                    <img src="/PWL_2024/resources/img/dettol.jpg" alt="Kopi">
                    <h3>Dettol</h3>
                    <p>Membunuh 99% kuman</p>
                    <a href="#">Detail</a>
                </div>
